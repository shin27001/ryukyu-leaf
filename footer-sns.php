<div class="mod_share">
  ...
  <ul class="mod_share__list">
    ...
    <li class="mod_share__item twitter"><a href="https://twitter.com/share? url=<?php echo $current_url; ?>&text=<?php echo esd_title(['echo'=>false])." | ".get_bloginfo('name'); ?>" rel="nofollow" target="_blank">

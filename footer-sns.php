<div class="mod_share">
  ...
  <ul class="mod_share__list">
    ...
    <li class="mod_share__item twitter"><a href="https://twitter.com/share? url=<?php echo $current_url; ?>&text=<?php echo get_the_title(); ?>" rel="nofollow" target="_blank">
    ...
    <li class="mod_share__item line"><a href="https://social-plugins.line.me/lineit/share?url=<?php echo $current_url; ?>" class="link">

<div class="mod_share">
  ...
  <ul class="mod_share__list">
    <li class="mod_share__item twitter"><a href="https://twitter.com/share?
  url=<?php echo get_the_permalink(); ?>&
  via={Twitter ID}&
  related={Twitter ID}&
  hashtags=web,webdesign&
  text=<?php echo get_the_title(); ?>" rel="nofollow" target="_blank">
        <p class="txt"><i class="fab fa-twitter symbol"></i><br>Twitterで<br>シェア</p>
      </a></li>
    <li class="mod_share__item facebook"><a href="http://www.facebook.com/share.php?u={URL}" class="link" target="_blank">

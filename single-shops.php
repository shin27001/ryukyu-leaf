    ...
    <div class="l-info">
      ...
      <div class="l-info__basic">
        ...
        <table class="l-info__table">
          ...
          <tr>
            <th>住所</th>
            <td>〒<?php the_field('zip_code'); ?>　<?php the_field('address'); ?><div class="mapbtn"><a href="https://www.google.com/maps/@?api=1&map_action=map&center=<?php the_field('address'); ?>&zoom=5" class="btn btn-m-red" target="blank">Google Mapへ</a></div>
            </td>
          </tr>
          <tr>

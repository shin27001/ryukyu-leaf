      ...
      <div class="content-inner">
        <div class="l-form">
          <?php
            ...
            $checked = ""; #初期化
          ?>
<?php //echo e('options', $data); ?>
<?php //echo e('payments', $data); ?>
<?php //echo e('coronas', $data); ?>
<?php //echo e('contact_policy', $data); ?>
<?php //echo e('written_oath', $data); ?>
          <form method="POST" id="registform" action="<?php echo esc_url( home_url('entry-confirm') ); ?>" enctype="multipart/form-data">
            ...
            <dl>
              ...
              <dd class="l-form__action"><input type="text" name="tanto_name" id="tanto_name" class="form-control" size="60" value="<?php echo e('tanto_name', $data); ?>" placeholder="例: 田中 太郎" /></dd>
              <!-- メールアドレス -->
              <dt>

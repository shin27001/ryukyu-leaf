      ...
      <div class="l-header__inner">
        ...
        <nav class="l-header__nav">
          <ul class="l-header__nav-list">
            ...
            <li class="l-header__nav-item"><?php echo (get_pref(false) == '沖縄') ? '<a href="https://gohan-tabi.com/okinawa"><i class="fas fa-external-link-alt"></i> 沖縄版</a></li>' : '<a href="https://gohan-tabi.com/kyoto"><i class="fas fa-external-link-alt"></i> 京都版</a></li>'; ?></li>
